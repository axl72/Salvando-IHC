					...
					<div class="single-items">
						<div class="proy-cat">
							<div class="proyecto-block-thumb">
								<a>
									<img class="proyecto-imagen" alt="Imagen del curso DATABRICKS" src="${proyecto.imagen}">
								</a>
							</div>
							<div class="proyecto-datos">
								...
								<div class="proyecto-block-content">
									...
									<div class="container-descripcion">
										<p>
											Lorem ipsum, dolor sit amet consectetur adipisicing elit. Neque aliquid in cupiditate eius
